/*=========================================================================
  ...
  Module:    $RCSfile: vtkPBufferRenderWindow.h,v $
  Language:  C++
...
=========================================================================*/
// .NAME vtkPBufferRenderWindow - Render OpenGL scene offscreen using SGI PBuffers.
// .SECTION Description
...
#ifndef __vtkPBufferRenderWindow_h
#define __vtkPBufferRenderWindow_h
...
class VTK_EXPORT vtkPBufferRenderWindow : public vtkXRenderWindow
{
protected:
...
public:
  ...
  static vtkPBufferRenderWindow *New() {return new vtkPBufferRenderWindow;};
  const char *GetClassName() {return "vtkPBufferRenderWindow";};
  ...
  // Write image as JPEG
  int WriteJPEGFile(char* fname, int compression);
  unsigned char *WriteJPEGMem(int compression, int *size);
