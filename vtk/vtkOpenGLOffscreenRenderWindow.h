/*=========================================================================
  ...
  Module:    $RCSfile: vtkOpenGLOffscreenRenderWindow.h,v $
  Language:  C++
...
public:
  static vtkOpenGLOffscreenRenderWindow *New();
  vtkTypeMacro(vtkOpenGLOffscreenRenderWindow,vtkXRenderWindow);
...
// The GetClassName is now def'd via the vtkTypeMacro (rf. vtkObject.h)
...
//  void SetPosition(int p[2]);
  ...
  // Write image as JPEG
  int WriteJPEGFile(char* fname, int quality);
  unsigned char *WriteJPEGMem(int quality, int *size);
