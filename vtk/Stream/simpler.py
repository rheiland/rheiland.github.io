...
gridReader.SetFileName('simpler.vtk')
gridReader.Update()
...
#-------------------------------------
#ren.GetActiveCamera().SetPosition(0.492188,0.492188,2.043559)
#ren.GetActiveCamera().SetFocalPoint(0.492188,0.492188,0.0)
#ren.GetActiveCamera().SetViewAngle(30.0)
#ren.GetActiveCamera().SetViewUp(0.000000,1.000000,0.0)
...
#light1 = lights.GetNextItem()
#light1.SetPosition( ren.GetActiveCamera().GetPosition() )
#light1.SetFocalPoint( ren.GetActiveCamera().GetFocalPoint() )
